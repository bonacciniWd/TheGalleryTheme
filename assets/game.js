...
cloudImage.src = '/logo.png'; // Definir o caminho da imagem
...
function drawClouds() {
  clouds.forEach((cloud) => {
    ctx.save();
    ctx.drawImage(cloudImage, cloud.x - cloud.width / 2, cloud.y - cloud.width / 2, cloud.width, cloud.width / 2); // Desenhar a imagem da nuvem
    ctx.restore();
